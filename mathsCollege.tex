\input{preambule}
\input{macros_answers} % les corrections sont regroupées à la fin du document
%\input{macros_sans_answers} % sans le package answers : les correction suivent les énoncés
...
TODO 
\begin{enumerate}
%\item calcul littéral voir Lebossé-Hémery p. 107 du pdf
\item pour les exos avec triangles semblables et exos de sixième, voir les lebossé-Hemery
\item mettre exos Alarcon
\item preuves de pythagore avec rotations 
\item preuve du thm de l'angle inscrit en 4ème ou cinquième avec triangles isocèles.
\item somme des angles dans un $n$-gone -> cinquième
\item Rajouter les exos-théorèmes sur chaque polygone classique : tous triangles, rectangles, carrés, losanges, parallélogrammes, cerf-volants, avec formulation par nombre d'axes de symétrie et centres de symétrie. Voire le Lebossé-Hémery pour ça.
\end{enumerate}
\end{comment}
...
% premiers exercices du Deslandes (mise en équation ?)
...
% prendre le problème  l'envers, commencer par la fin
...
%Nouveauté : somme des angles d'un triangle 
...
%Voir les exercices de \url{http://debart.pagesperso-orange.fr/college/geometrie_cinquieme.html}, à la fin : aires de triangles etc. 5ème.
...
Soit $ABCD$ un trapèze, et $O$ l'intersection de ses diagonales. Montrer que les triangles $OBC$ et $ODA$ on la même aire.
\begin{center}
\definecolor{uuuuuu}{rgb}{0.26666666666666666,0.26666666666666666,0.26666666666666666}
\definecolor{xdxdff}{rgb}{0.49019607843137253,0.49019607843137253,1.}
\definecolor{qqqqff}{rgb}{0.,0.,1.}
...
Soit $ABC$ un triangle et $I$, $J$ les milieux de $[AB]$ et $[BC]$.
